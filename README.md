...
| Alpha 帖楼内新回复 | 并入上行卡片：账号发帖条目后附「🧵 Alpha 帖新回复」条目，带被回复原帖链接，计数行含「N 条 Alpha 楼内回复」 |
...
*文档版本: v4.7*
*最后更新: 2026-09-08*
*上次更新说明: Alpha 分类「盲盒」关键词收紧（须伴随 alpha 上下文，防活动文案蹭词误报）；v4.6 Alpha 楼内回复监控定稿——搜索式 `from:A to:B` 逐对抓取 + syndication 补父帖 ID，自回复与跨号互回均推*
