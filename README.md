...
脚本通过 Feishu REST API 直接向飞书群聊发送**交互卡片**（interactive）消息，包含 token 缓存机制。所有消息均为卡片格式。新帖卡片为**折叠式**（v4.9，需飞书 ≥ V7.9）：每条推文/回复收进折叠面板，标题显示摘要与 🔴 ALPHA 标记，点开看全文与链接；顶部横幅与计数行常显：
...
- ✅ 折叠卡片（collapsible_panel，每条推文/回复默认收起，标题带摘要与 ALPHA 标记）
...
*文档版本: v4.9*
*最后更新: 2026-09-23*
*上次更新说明: 飞书卡片折叠化——每条推文/回复收进 collapsible_panel（默认收起，标题带摘要与 ALPHA 标记）；v4.8 回复卡片附原帖正文引用*
